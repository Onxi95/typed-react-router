...
type GetQueryParamsFromHash<T> = T extends ReadonlyArray<string>
    ? { [K in T[number]]: string }
    : null;

export type BuildUrl<RouteHash extends Record<string, { path: string, queryParams?: ReadonlyArray<string> }>> = <
